...
- public - misc files that the web app needs to be served, like index.html
  These files will  be copied into the runnable site; symlink targets duplicated.
  -  fonts/ - math fonts for docs
  -  index.html, manifest.json, robots.txt - the usual
  -  images/ - pngs etc used in app (many more embedded with src)
...
- build/ - where a production build goes, not always there
