...
vec3 cxToColor(vec2 psi) {
	if (psi.y == 0.) {
		...
		if (psi.x == 0.) {
			...
			//console.log('     line 22, psi.x=', psi.x);
			if (psi.x > 0.) {
	...
	if (slope < -sqrtOneThird) {
		...
		if (psi.y > 0.) {
			...
			float gradient = psi.y / psi.x * sqrtOneThird;
			//console.log('     line 59, gradient=', gradient.toFixed(4));
			return vec3(0., 1., 1.+gradient);  // cyan...green
		}
		else {
			//console.log('     330°, magenta... red');
			float gradient = psi.y / psi.x * sqrtOneThird;
			//console.log('     line 65, gradient=', gradient.toFixed(4));
	...
	//console.log('     line 73, gradient', gradient.toFixed(4));
	if (psi.y > 0.) {
